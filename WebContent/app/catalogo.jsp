...
<body>
	...
	<div class="container text-center w-50">
		<div class="row justify-content-between">
			<div class="col-12 mb-4">
				<form id="autocompleteWineForm"
					action="<%=Routes.BASE_URL + Routes.CATALOGO%>" method="get">
	...
	<script src="../js/wine-autocomplete.js"></script>
	...
	<script>
		$("#wineQuery")
			.on(
					"input",
					() => onWineSearchChange(
							"<%=Routes.BASE_URL + Routes.WINE_AUTOCOMPLETE%>", 
							$("#wineQuery").val()
					)
			);
	</script>
